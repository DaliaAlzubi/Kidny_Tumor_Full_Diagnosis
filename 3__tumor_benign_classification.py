# -*- coding: utf-8 -*-
"""3__Tumor_Benign_classification.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1WtcehIc1XRn8rT0TcmjnnMBc9cJn6upY
"""
...
hist=model.fit(training_set,
                         steps_per_epoch = (1675 /128),
                         epochs = 50,
                         validation_data = validation_set,
                         validation_steps = (415 /128))
...
path='/content/sample_data/test/Adenoma'
l_Adenoma =[]
...
for i in range(len(l_Adenoma)):
  xx = model.predict(l_Adenoma[i])
  xx = np.round(xx).astype(int)
  l_Adenoma_result.append(xx[0][1])

l_Adenoma_draw=[]
for i in range(len(l_Adenoma_result)):
    if(l_Adenoma_result[i]== 0):
...
path='/content/sample_data/test/Angiomyolipoma'
l_Angiomyolipoma =[]
...
for i in range(len(l_Angiomyolipoma)):
  xx = model.predict(l_Angiomyolipoma[i])
  xx = np.round(xx).astype(int)
  l_Angiomyolipoma_result.append(xx[0][1])

l_Angiomyolipoma_draw=[]
for i in range(len(l_Angiomyolipoma_result)):

    if (l_Angiomyolipoma_result[i]== 1):
