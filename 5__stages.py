...
Original file is located at
    https://colab.research.google.com/drive/1cL6_3OcxfAgx4D3ztLDlrS37Di9bkWh0
"""
...
validation_set = test_datagen.flow_from_directory('/content/sample_data/validation',
                                            target_size = (224,224),
                                            batch_size = 32,
                                            class_mode = 'categorical')
...
path='/content/sample_data/test/I'
l_I =[]
...
path='/content/sample_data/test/II'
l_II =[]
...
for i in range(len(l_II)):
  xx = model.predict(l_II[i])
  xx = np.round(xx).astype(int)
  
  if (xx[0][0] == 1):
        l_II_draw.append("I")
        l_II_result.append(0)
  elif (xx[0][1] == 1):
        l_II_draw.append("II")
        l_II_result.append(1)
  elif (xx[0][2] == 1):
        l_II_draw.append("III")
        l_II_result.append(2)
  else :
        l_II_draw.append("IIII")
        l_II_result.append(3)
...
path='/content/sample_data/test/III'
l_III =[]
...
for i in range(len(l_III)):
  ...
  xx = model.predict(l_III[i])
  xx = np.round(xx).astype(int)
  
  if (xx[0][0] == 1):
        l_III_draw.append("I")
        l_III_result.append(0)
  elif (xx[0][1] == 1):
        l_III_draw.append("II")
        l_III_result.append(1)
  elif (xx[0][2] == 1):
        l_III_draw.append("III")
        l_III_result.append(2)
  else :
        l_III_draw.append("IIII")
        l_III_result.append(3)
...
for i in range(len(l_IIII)):
  ...
  xx = model.predict(l_IIII[i])
  xx = np.round(xx).astype(int)
  
  if (xx[0][0] == 1):
        l_IIII_draw.append("I")
        l_IIII_result.append(0)
  elif (xx[0][1] == 1):
        l_IIII_draw.append("II")
        l_IIII_result.append(1)
  elif (xx[0][2] == 1):
        l_IIII_draw.append("III")
        l_IIII_result.append(2)
  else :
        l_IIII_draw.append("IIII")
        l_IIII_result.append(3)
