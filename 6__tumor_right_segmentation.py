# -*- coding: utf-8 -*-
"""6__Tumor_right_segmentation.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1je9DOlOWdatGhuphUbyMj9h-Q1FbxALK
"""
...
def augmentation_for_small_labels ( x : list , y : list , targets : list ,number_gen_for_img : int   ) : 
...
X_new , Y_new = augmentation_for_small_labels( X , y , ['Lower','Undefined'] , 1 )
...
label_0 = labels[0]
path='/content/sample_data/test/{}'.format(label_0)
l_0 =[]
...
for i in range(len(l_0)):
  xx = model.predict(l_0[i])
  xx = np.round(xx).astype(int)
  if (xx[0][0] == 1):
        l_0_draw.append("Healthy")
        l_0_result.append(0)
  elif (xx[0][1] == 1):
        l_0_draw.append("Lower")
        l_0_result.append(1)
  elif (xx[0][2] == 1):
        l_0_draw.append("Undefined")
        l_0_result.append(2)
  else :
        l_0_draw.append("Upper")
        l_0_result.append(3)
...
from keras.preprocessing import image
label_1 = labels[1]
path='/content/sample_data/test/{}'.format(label_1)
l_1 =[]
...
for i in range(len(l_1)):
  ...
  xx = model.predict(l_1[i])
  xx = np.round(xx).astype(int)
  if (xx[0][0] == 1):
        l_1_draw.append("Healthy")
        l_1_result.append(0)
  elif (xx[0][1] == 1):
        l_1_draw.append("Lower")
        l_1_result.append(1)
  elif (xx[0][2] == 1):
        l_1_draw.append("Undefined")
        l_1_result.append(2)
  else :
        l_1_draw.append("Upper")
        l_1_result.append(3)
...
from keras.preprocessing import image
label_2 = labels[2]
path='/content/sample_data/test/{}'.format(label_2)
l_2 =[]
...
for i in range(len(l_2)):
  ...
  xx = model.predict(l_2[i])
  xx = np.round(xx).astype(int)
  if (xx[0][0] == 1):
        l_2_draw.append("Healthy")
        l_2_result.append(0)
  elif (xx[0][1] == 1):
        l_2_draw.append("Lower")
        l_2_result.append(1)
  elif (xx[0][2] == 1):
        l_2_draw.append("Undefined")
        l_2_result.append(2)
  else :
        l_2_draw.append("Upper")
        l_2_result.append(3)
...
from keras.preprocessing import image
label_3 = labels[3]
path='/content/sample_data/test/{}'.format(label_3)
l_3 =[]
...
for i in range(len(l_3)):
  ...
  xx = model.predict(l_3[i])
  xx = np.round(xx).astype(int)
  if (xx[0][0] == 1):
        l_3_draw.append("Healthy")
        l_3_result.append(0)
  elif (xx[0][1] == 1):
        l_3_draw.append("Lower")
        l_3_result.append(1)
  elif (xx[0][2] == 1):
        l_3_draw.append("Undefined")
        l_3_result.append(2)
  else :
        l_3_draw.append("Upper")
        l_3_result.append(3)
