# -*- coding: utf-8 -*-
"""4__Tumor_Malignant_classification.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1AYZftUWTOD9og5HxYHo669dCcphhsMSz
"""
...
path='/content/sample_data/test/RCC'
l_RCC =[]
...
for i in range(len(l_RCC)):
  xx = model.predict(l_RCC[i])
  xx = np.round(xx).astype(int)
  l_RCC_result.append(xx[0][1])
...
path='/content/sample_data/test/Secondary'
l_Secondary =[]
...
for i in range(len(l_Secondary)):
  xx = model.predict(l_Secondary[i])
  xx = np.round(xx).astype(int)
  l_Secondary_result.append(xx[0][1])


l_Secondary_draw=[]
for i in range(len(l_Secondary_result)):

    if (l_Secondary_result[i] == 1):
